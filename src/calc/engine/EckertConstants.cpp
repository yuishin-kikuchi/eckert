...
EckertConstants::engineeringConstantValues = {
	// A size paper (ISO)
	{ "a0.s", { GEN_INTEGER(841), "Short side of A0 in mm" } },
	{ "a1.s", { GEN_INTEGER(594), "Short side of A1 in mm" } },
	{ "a2.s", { GEN_INTEGER(420), "Short side of A2 in mm" } },
	{ "a3.s", { GEN_INTEGER(297), "Short side of A3 in mm" } },
	{ "a4.s", { GEN_INTEGER(210), "Short side of A4 in mm" } },
	{ "a5.s", { GEN_INTEGER(148), "Short side of A5 in mm" } },
	{ "a6.s", { GEN_INTEGER(105), "Short side of A6 in mm" } },
	{ "a7.s", { GEN_INTEGER(74), "Short side of A7 in mm" } },
	{ "a8.s", { GEN_INTEGER(52), "Short side of A8 in mm" } },
	{ "a9.s", { GEN_INTEGER(37), "Short side of A9 in mm" } },
	{ "a0.l", { GEN_INTEGER(1189), "Long side of A0 in mm" } },
	{ "a1.l", { GEN_INTEGER(841), "Long side of A1 in mm" } },
	{ "a2.l", { GEN_INTEGER(594), "Long side of A2 in mm" } },
	{ "a3.l", { GEN_INTEGER(420), "Long side of A3 in mm" } },
	{ "a4.l", { GEN_INTEGER(297), "Long side of A4 in mm" } },
	{ "a5.l", { GEN_INTEGER(210), "Long side of A5 in mm" } },
	{ "a6.l", { GEN_INTEGER(148), "Long side of A6 in mm" } },
	{ "a7.l", { GEN_INTEGER(105), "Long side of A7 in mm" } },
	{ "a8.l", { GEN_INTEGER(74), "Long side of A8 in mm" } },
	{ "a9.l", { GEN_INTEGER(52), "Long side of A9 in mm" } },
	// B size paper (JIS)
	{ "b0.s", { GEN_INTEGER(1030), "Short side of B0 in mm" } },
	{ "b1.s", { GEN_INTEGER(728), "Short side of B1 in mm" } },
	{ "b2.s", { GEN_INTEGER(515), "Short side of B2 in mm" } },
	{ "b3.s", { GEN_INTEGER(364), "Short side of B3 in mm" } },
	{ "b4.s", { GEN_INTEGER(257), "Short side of B4 in mm" } },
	{ "b5.s", { GEN_INTEGER(182), "Short side of B5 in mm" } },
	{ "b6.s", { GEN_INTEGER(128), "Short side of B6 in mm" } },
	{ "b7.s", { GEN_INTEGER(91), "Short side of B7 in mm" } },
	{ "b8.s", { GEN_INTEGER(64), "Short side of B8 in mm" } },
	{ "b9.s", { GEN_INTEGER(45), "Short side of B9 in mm" } },
	{ "b0.l", { GEN_INTEGER(1456), "Long side of B0 in mm" } },
	{ "b1.l", { GEN_INTEGER(1030), "Long side of B1 in mm" } },
	{ "b2.l", { GEN_INTEGER(728), "Long side of B2 in mm" } },
	{ "b3.l", { GEN_INTEGER(515), "Long side of B3 in mm" } },
	{ "b4.l", { GEN_INTEGER(364), "Long side of B4 in mm" } },
	{ "b5.l", { GEN_INTEGER(257), "Long side of B5 in mm" } },
	{ "b6.l", { GEN_INTEGER(182), "Long side of B6 in mm" } },
	{ "b7.l", { GEN_INTEGER(128), "Long side of B7 in mm" } },
	{ "b8.l", { GEN_INTEGER(91), "Long side of B8 in mm" } },
	{ "b9.l", { GEN_INTEGER(64), "Long side of B9 in mm" } },
	// US paper size
	{ "let.s", { GEN_RATIONAL2(2159, 10), "Short side of US letter size in mm" } },
	{ "leg.s", { GEN_RATIONAL2(2159, 10), "Short side of US legal size in mm" } },
	{ "let.l", { GEN_RATIONAL2(1397, 5), "Long side of US letter size in mm" } },
	{ "leg.l", { GEN_RATIONAL2(1778, 5), "Long side of US legal size in mm" } },
	{ "let.si", { GEN_RATIONAL2(17, 2), "Short side of US letter size in inch" } },
	{ "leg.si", { GEN_RATIONAL2(17, 2), "Short side of US legal size in inch" } },
	{ "let.li", { GEN_INTEGER(11), "Long side of US letter size in inch" } },
	{ "leg.li", { GEN_INTEGER(14), "Long side of US legal size in inch" } },
};
