...
const std::map <std::string, std::string> StringTables::instructionMessage = {
	...
	{ "OP_FACT", "FACTORIAL X!" },
	{ "OP_PERM", "PERMUTATIONS P(y, x)" },
	{ "OP_COMB", "COMBINATIONS C(y, x) (binomial coefficient)" },
	// exponent, logarithm
	{ "OP_SQ", "SQUARE" },
	{ "OP_SQRT", "SQUARE ROOT" },
	{ "OP_CBRT", "CUBE ROOT" },
