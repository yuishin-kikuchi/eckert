...
const std::map <unsigned int, CoversionCriterion> UnitConverter::criteria = {
	...
	{ VOLI_IMGAL, { "/img", U_VOLUME_I, GEN_RATIONAL2(100000000LL, 454609LL), GEN_INTEGER(0) } },
	{ VOLI_USGAL, { "/usg", U_VOLUME_I, GEN_RATIONAL2(125000000000LL, 473176473LL), GEN_INTEGER(0) } },
